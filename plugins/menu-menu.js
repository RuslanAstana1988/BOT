...
┣ ඬ⃟ 👑 _${usedPrefix}enable *ограничить*_
┣ ඬ⃟ 👑 _${usedPrefix}disable *ограничить*_
...
handler.command = /^(menu|menú|memu|меню|memú|help|info|comandos|allmenu|2help|menu1.2|ayuda|commands|commandos|cmd)$/i
handler.exp = 50
handler.fail = null
